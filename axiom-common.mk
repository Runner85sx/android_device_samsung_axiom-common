...
$(LOCAL_PATH) := device/samsung/axiom-common

$(call inherit-product, $(SRC_TARGET_DIR)/product/languages_full.mk)

# Get non-open-source specific aspects if available
$(call inherit-product-if-exists, vendor/samsung/axiom-common/axiom-common-vendor.mk)

# Overlay
DEVICE_PACKAGE_OVERLAYS += device/samsung/axiom-common/overlay
